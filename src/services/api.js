...
export function taskFromApi(task) {
  return {
    ...
    completedAtTimestamp: task.completed_at || '',
...
export function attachmentFromApi(attachment) {
  return {
    ...
    url: attachment.optimized_url || attachment.file_url || attachment.url,
    filePath: attachment.file_path || '',
    fileUrl: attachment.file_url || '',
    thumbnailPath: attachment.thumbnail_path || '',
    thumbnailUrl: attachment.thumbnail_url || '',
    optimizedPath: attachment.optimized_path || '',
    optimizedUrl: attachment.optimized_url || '',
