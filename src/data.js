...
export const initialTasks = [
  ...
  { id: 'task-6', clientId: 'client-2', title: 'Distributor presentation', description: 'Prepare a concise sales presentation for distributor meetings.', category: 'Presentation', priority: 'Low', deadline: '2026-06-30', status: 'New', proofLink: '', billable: true, amount: 8500, assignee: 'SB', completedAt: '', paymentStatus: 'Unpaid', invoiceStatus: 'Not invoiced' },
