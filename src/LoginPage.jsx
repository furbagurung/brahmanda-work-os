    ...
    <main className="grid min-h-screen bg-canvas lg:grid-cols-[minmax(0,1fr)_520px]">
      <section className="hidden border-r border-line bg-white p-12 lg:flex lg:flex-col lg:justify-between">
        <div className="flex items-center gap-3">
          <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue text-white"><Command size={19} /></span>
      ...
      <section className="flex items-center justify-center p-5 sm:p-10">
        <div className="w-full max-w-sm rounded-2xl border border-line bg-white p-7 shadow-[0_12px_40px_rgba(24,24,27,0.08)] sm:p-8">
          ...
          <form className="mt-8 space-y-5" onSubmit={submit}>
            <label className="block">
              ...
              <span className="flex items-center rounded-xl border border-zinc-300 bg-white px-3 focus-within:border-blue focus-within:ring-2 focus-within:ring-blue/10">
